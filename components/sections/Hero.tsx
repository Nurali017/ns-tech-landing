    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-primary pt-20">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full bg-accent-magenta/20 blur-3xl mix-blend-overlay" />
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mt-4">
                            <a href="https://apps.apple.com/kz/app/minifootball/id6449434914" target="_blank" rel="noopener noreferrer">
                                <Button size="lg" className="bg-white text-primary hover:bg-gray-100 rounded-full text-lg h-14 px-8">
                                    App Store
                                </Button>
                            </a>
                            <a href="https://play.google.com/store/apps/details?id=kz.llf.onesportone" target="_blank" rel="noopener noreferrer">
                                <Button size="lg" className="bg-white text-primary hover:bg-gray-100 rounded-full text-lg h-14 px-8">
                                    Google Play
                                </Button>
                            </a>
